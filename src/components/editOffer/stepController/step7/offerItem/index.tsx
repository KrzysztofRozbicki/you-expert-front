...
const OfferItem: React.FC<{ offer: IEditOfferData; link: string }> = (
  props
) => {
  ...
  const reprensentationImage = useMemo(() => {
    return offer.images[0]?.imageUrl || offer.images[0]?.file;
  }, [offer]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text fontWeight="600" p="0 40px 24px 40px" fontSize="0.8rem">
          {offer.serviceTitle}
        </Text>
        <Flex
